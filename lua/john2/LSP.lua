local LSP = {
		...
		LirDir = {fg = C.light_blue, },
		LirSymLink = {fg = C.cyan, },
		LirEmptyDirText = {fg = C.light_blue, },
		...
		StatusLine = {fg = C.light_gray, bg = C.alt_bg, },
		StatusLineNC = {fg = C.gray, bg = C.alt_bg, },
		StatusLineSeparator = {fg = C.alt_bg, bg = C.gray, },
		StatusLineTerm = {fg = C.alt_bg, bg = C.gray, },
		StatusLineTermNC = {fg = C.alt_bg, bg = C.gray, },
		...
		xmlTag = {fg = C.light_blue, },
		xmlTagName = {fg = C.light_blue, },
		xmlEndTag = {fg = C.light_blue, },
		...
		diffFileId = {fg = C.light_blue, style = "bold,reverse", },
